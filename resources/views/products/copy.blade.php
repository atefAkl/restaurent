    ...
    <div class="p-3 mb-3 shadow-sm">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-dark fw-bold">اضافة منتج نسخة</h1>
                    <p class="text-muted mb-0 mt-2">إضافة نسخة من منتج لقائمة الأصناف</p>
                </div>
                <div class="btn-group">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="name_ar" name="name_ar"
                                    value="{{ old('name_ar', $product) }}" required>
                                @error('name_ar')
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="category_id" name="category_id" required>
                                    ...
                                    <option value="{{ $category->id }}"
                                        {{ (request()->has('category_id') && request('category_id') == $category->id) || old('category_id', $product) == $category->id ? 'selected' : '' }}>
                                        {{ $category->name_ar }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="price" name="price"
                                           autocomplete value="{{ old('price', $product) }}" step="0.01" min="0" required>
                                        @error('price')
                                        <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="cost" name="cost"
                                           autocomplete value="{{ old('cost', $product) }}" step="0.01" min="0">
                                        @error('cost')
                                        <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                    </div>
